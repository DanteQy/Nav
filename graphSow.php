        ...
        $(function () {
            ...
            function getRandomData() {
                ...
                while (data.length < totalPoints) {
                    var prev = data.length > 0 ? data[data.length - 1] : sowV
                        , y = prev;
                    data.push(sowV);
                }
            ...
            var plot = $.plot("#placeholder", [getRandomData()], {
                ...
                , yaxis: {
                    min: 0
                    , max: 10 //qua ci va il valore massimo dell'asse delle ordinate
                }
                , xaxis: {
                    show: false
                }
...
<body>
    ...
    <div class="read">
        <p class="sow" style="font-size: 6vh;"> </p>
    </div>
