...
<head>
    ...
    <title>Apparent Wind Speed</title>
        ...
        $(function () {
            ...
            function getRandomData() {
                ...
                while (data.length < totalPoints) {
                    var prev = data.length > 0 ? data[data.length - 1] : awsV
                        , y = prev;
                    data.push(awsV);
                    console.log(awsV);
                }
            ...
            var plot = $.plot("#placeholder", [getRandomData()], {
                ...
                , yaxis: {
                    min: 0
                    , max: 30 //qua ci va il valore massimo dell'asse delle ordinate
                }
                , xaxis: {
                    show: false
                }
...
<body>
    ...
    <div class="read">
        <p class="aws" style="font-size: 6vh;"> </p>
    </div>
