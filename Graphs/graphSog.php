...
<head>
    ...
    <link href="UI/css/stileGraphs.css" rel="stylesheet" type="text/css">
    <link href="UI/css/stile6x.css" rel="stylesheet" type="text/css">
    <!--[if lte IE 8]><script language="javascript" type="text/javascript" src="../../excanvas.min.js"></script><![endif]-->
    <script language="javascript" type="text/javascript" src="UI/javascript/jquery.min.js"></script>
    <script type="text/JavaScript" type="text/javascript" src="UI/javascript/updating.js"></script>
    <script type="text/JavaScript" src="../javascript/resize.js"></script>
    <script language="javascript" type="text/javascript" src="UI/javascript/jquery.flot.js"></script>
        ...
        $(function () {
            ...
            function getRandomData() {
                ...
                while (data.length < totalPoints) {
                    var prev = data.length > 0 ? data[data.length - 1] : sogV
                        , y = prev;
                    data.push(sogV);
                }
...
<body>
    ...
    <div class="read">
        <p class="sog" style="font-size: 6vh;"> </p>
    </div>
